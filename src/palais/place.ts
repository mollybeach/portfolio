 ...
 * the Lakehouse and the Steaming Lagoon are rooms you can walk into. Every room stays on the page
 ...
 *
 * The room is kept in the address (#closet, #lakehouse, #lagoon), so a refresh or a shared link
 * opens the same room.
 */

export const PLACES = ["palace", "closet", "lakehouse", "lagoon"] as const;
