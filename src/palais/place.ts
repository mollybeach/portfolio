 ...
 * the Lakehouse, the Steaming Lagoon, the Rainwood and the Amphitheatre are rooms you can walk into. Every room stays on the page
 ...
 *
 * The room is kept in the address (#closet, #lakehouse, #lagoon, #rainwood, #gorge), so a refresh or a shared link
 * opens the same room.
 */

export const PLACES = ["palace", "closet", "lakehouse", "lagoon", "rainwood", "gorge"] as const;
