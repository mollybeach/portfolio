...
export const PROPS = catalogue({
  ...
  poster_danish_composer_pianist_portrait_vintage_sticker: {
    label: "a vintage poster of a Danish composer at his chair",
    plane: "mid",
    metres: 0.62,
  },
  tree_christmas_decorated_presents_sticker: {
    label: "a Christmas tree, lit, with the presents under it",
    plane: "mid",
    metres: 1.3,
  },
  ...
  character_molly_sticker: { label: "Molly", plane: "near", metres: 1.02 },
  character_kate_sticker: { label: "Kate", plane: "near", metres: 1.48 },
  character_leonardo_sticker: { label: "Leonardo", plane: "near", metres: 0.64 },
  character_brea_sticker: { label: "Brea", plane: "near", metres: 1.61 },
  character_madeleine_sticker: { label: "Madeleine", plane: "near", metres: 1.19 },
  character_moselle_sticker: { label: "Moselle", plane: "near", metres: 0.93 },
  character_kayenat_sticker: { label: "Kayenat", plane: "near", metres: 0.92 },
  character_ella_sticker: { label: "Ella", plane: "near", metres: 0.81 },
  character_sarah_sticker: { label: "Sarah", plane: "near", metres: 0.75 },
  character_stephanie_sticker: { label: "Stephanie", plane: "near", metres: 0.54 },
  character_jonathan_sticker: { label: "Jonathan", plane: "near", metres: 1.05 },
  character_dream_sticker: { label: "Dream", plane: "near", metres: 1.22 },
  character_bryan_sticker: { label: "Bryan", plane: "near", metres: 1.22 },
  character_jessica_sticker: { label: "Jessica", plane: "near", metres: 1.12 },
  character_peter_sticker: { label: "Peter", plane: "near", metres: 0.58 },
  character_jordan_sticker: { label: "Jordan", plane: "near", metres: 1.08 },
  character_destiny_sticker: { label: "Destiny", plane: "near", metres: 0.66 },
  character_jericha_sticker: { label: "Jericha", plane: "near", metres: 1.09 },
  character_jerusha_sticker: { label: "Jerusha", plane: "near", metres: 1.04 },
  character_alisha_sticker: { label: "Alisha", plane: "near", metres: 1.47 },
  character_jeannette_sticker: { label: "Jeannette", plane: "near", metres: 1.18 },
  character_chade_sticker: { label: "Chade", plane: "near", metres: 1.13 },
  snail_giant_african_land_shell_sticker: { label: "a giant African land snail", plane: "near", metres: 0.95 },
  snail_giant_african_land_shell_facing_left_sticker: { label: "a giant African land snail, facing left", plane: "near", metres: 0.95 },
  /* Giant means giant: these stand as tall as the people do, and the + in
