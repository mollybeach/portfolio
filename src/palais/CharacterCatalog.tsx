...
const CAST: Character[] = [
  ...
  },
  {
    ...
    name: "Madeleine",
    tag: "friend of the Palais",
    blurb: "Madeleine in emerald: a beaded lace gown that holds to her and then lets go, with a satin overskirt spread out behind her, her hair in long waves and her eyes somewhere past you.",
    notes: ["An emerald beaded lace mermaid gown", "Long sheer sleeves worked in the same lace", "A satin overskirt opening into a wide train", "Gold hoops, and her hair in long waves"],
    color: "#1d7a58",
    face: 0.08,
  ...
  },
  {
    ...
    name: "Bryan",
    tag: "friend of the Palais",
    blurb: "Bryan in a crimson suit with a robe of crimson and gold brocade thrown over his shoulders, black leather gloves and two jeweled brooches, grinning straight at you.",
    notes: ["A crimson double-breasted suit", "A crimson and gold brocade robe to the floor", "Black leather gloves and a black silk tie", "A pearl brooch, a black sunburst brooch and a gold chain"],
    color: "#9b1b30",
    face: 0.07,
  ...
  },
  {
    ...
    name: "Alisha",
    tag: "friend of the Palais",
    blurb: "Alisha crowned May Queen, standing in a whole meadow of a gown — cornflowers, daisies, poppies and cosmos to the ground, with a great fan of flowers rising behind her head.",
    notes: ["A gown made of nothing but wildflowers, down to the grass", "A fan of blossom standing up behind her like a crown", "Daisies and cornflowers caught in her hair", "A small gold bindi, and a smile she is keeping to herself"],
    color: "#d6457e",
    face: 0.24,
