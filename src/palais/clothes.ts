...
const WIDE: Line[] = [
  ...
  { id: "cubby-row-1", name: "Cubbies · middle row", ids: ["temu-lace-gloves", "black-long-ribbon-bow"], from: [487, 577], to: [543, 572], w: [26, 24], z: 36 },
  ...
  { id: "window-hooks-top", name: "Window moulding · hooks across the top", ids: ["shein-white-fur-hat", "shein-bear-ear-bonnet", "shein-mint-fur-bucket-hat", "shein-lamb-bonnet", "shein-black-fur-beanie", "icelandic-white-fur-hat"], from: [640, 281], to: [1180, 281], w: [60, 60], hang: true, z: 36, hooks: 12 },
  { id: "window-hooks-side", name: "Window moulding · hooks down the right", ids: ["etsy-purple-veil", "temu-mantilla", "temu-fur-headband", "etsy-bernadette-veil"], from: [1219, 336], to: [1219, 636], w: [54, 54], hang: true, z: 36, hooks: 6 },
  { id: "seat", name: "Window seat", ids: ["temu-saddle-bag", "shein-fluffy-shawl", "temu-bow-handbag", "pink-sherpa-pom-pom-bucket-bag"], from: [918, 690], to: [1020, 690], w: [74, 74], z: 20 },
  ...
  { id: "shoes", name: "Shoes on the floor", ids: ["shein-mint-maryjanes", "amz-coutgo-heels", "amz-lolita-maryjanes", "amz-maryjanes-kalstage", "amz-tstrap-maryjanes", "shein-bow-loafers", "amz-birkenstock-gizeh", "temu-hamster-slippers", "amz-roller-skates", "dh-rain-boots", "tt-black-slingbacks", "tt-red-slingbacks", "shein-fur-snow-boots", "bw-bow-slingback-heels", "sage-burgundy-bow-slingback-heels", "yellow-bow-kitten-heels", "black-patent-chain-platform-loafers", "black-patent-triple-strap-platform-mary-janes"], from: [560, 1030], to: [1380, 1030], w: [84, 84], z: 60 },
  ...
  { id: "outer-right-top", name: "Outer right bay · top bar", ids: ["black-ruffle-pleated-skirt", "black-belted-pleated-shorts", "white-feather-angel-wings-halo-set", "black-feather-angel-wings-halo-set"], from: [1830, 76], to: [1664, 130], w: [84, 76], hang: true, z: 30 },
...
const TALL: Line[] = [
  ...
  { id: "right-low", name: "Right bay · lower rail", ids: ["shein-fairisle-skirt", "shein-plaid-bowskirt", "shein-plaid-tieskirt", "shein-pleated-khaki", "ref-sutton-shorts", "ref-ren-skirt", "strawberry-print-pink-string-bikini", "black-pink-trim-string-bikini"], from: [800, 876], to: [742, 864], w: [62, 56], hang: true, z: 72 },
  // the window seat
  { id: "seat", name: "Window seat", ids: ["temu-saddle-bag", "temu-fur-buckethat", "temu-rose-beanie", "shein-fluffy-shawl", "temu-fur-headband", "temu-bow-handbag", "dh-check-tote", "dh-hobo-bag", "dh-brown-tote", "shein-bear-ear-bonnet", "shein-black-fur-beanie", "shein-lamb-bonnet", "shein-white-fur-hat", "shein-mint-fur-bucket-hat", "burberry-canvas-tote", "prada-blue-bag", "gucci-gg-shoulder-bag", "icelandic-white-fur-hat", "pink-sherpa-pom-pom-bucket-bag"], from: [318, 948], to: [578, 948], w: [50, 50], z: 20 },
  ...
  { id: "shoes", name: "Shoes on the floor", ids: ["shein-mint-maryjanes", "amz-coutgo-heels", "amz-lolita-maryjanes", "amz-maryjanes-kalstage", "amz-tstrap-maryjanes", "shein-bow-loafers", "amz-birkenstock-gizeh", "temu-hamster-slippers", "amz-roller-skates", "dh-rain-boots", "tt-black-slingbacks", "tt-red-slingbacks", "shein-fur-snow-boots", "bw-bow-slingback-heels", "sage-burgundy-bow-slingback-heels", "yellow-bow-kitten-heels", "black-patent-chain-platform-loafers", "black-patent-triple-strap-platform-mary-janes"], from: [120, 1650], to: [820, 1650], w: [72, 72], z: 60 },
  // the outer left bay (a phone crops some of it) and the shelf in the inner right bay
  { id: "outer-left-low", name: "Outer left bay · lower rail", ids: ["cider-ditsy-layered-dress", "cider-jacquard-dress", "cider-embroidered-dress", "cider-tie-shoulder-dress", "cider-toile-dress", "cider-corduroy-dress", "cider-lemon-dress", "cider-puff-sleeve-dress", "cider-floral-midi-dress", "romi-alya-dress", "yellow-charlotte-dress"], from: [84, 506], to: [140, 552], w: [80, 70], hang: true, z: 80 },
