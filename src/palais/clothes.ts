...
export const CLOTHES = wardrobe({
  ...
  "bw-bow-slingback-heels-front": { label: "Black-and-white bow slingback heels, front on", store: "Closet", bought: "", kind: "shoes" },
  ...
  "louis-vuitton-damier-peep-toe-heels-front": { label: "Louis Vuitton Damier peep-toe heels, front on", store: "Closet", bought: "", kind: "shoes" },
...
const WIDE: Line[] = [
  ...
  { id: "rack-right", name: "Right rolling rack", ids: ["dh-puffer-jacket", "etsy-burgundy-velvet-hooded-coat", "white-fur-hood-parka", "dh-goose-jacket-pink", "amz-floral-sweatshirt", "shein-halfzip", "temu-tie-cardigan", "temu-heart-bikini", "dh-fur-coat", "dh-cc-bikini", "tt-striped-vest-set", "tt-striped-collar-set", "rhone-utility-trench-navy", "zeagoo-fur-lapel-wool-coat-navy", "maroon-wool-trench-coat", "green-wool-cropped-jacket-ruffle-skirt-set", "navy_satin_lace_slip_dress_sticker", "cream_rose_floral_lace_dress_sticker", "ivory_satin_lace_slip_dress_sticker", "forest_green_lace_satin_dress_sticker"], from: [1066, 612], to: [1314, 612], w: [112, 104], hang: true, z: 46 },
  // every pair of shoes, lined up on the tiles in front
  { id: "shoes", name: "Shoes on the floor", ids: ["shein-mint-maryjanes", "amz-coutgo-heels", "amz-lolita-maryjanes", "amz-maryjanes-kalstage", "amz-tstrap-maryjanes", "shein-bow-loafers", "amz-birkenstock-gizeh", "temu-hamster-slippers", "amz-roller-skates", "dh-rain-boots", "tt-black-slingbacks", "tt-red-slingbacks", "shein-fur-snow-boots", "bw-bow-slingback-heels", "bw-bow-slingback-heels-front", "sage-burgundy-bow-slingback-heels", "yellow-bow-kitten-heels", "black-patent-chain-platform-loafers", "black-patent-triple-strap-platform-mary-janes", "louis-vuitton-damier-peep-toe-heels", "louis-vuitton-damier-peep-toe-heels-front", "green-suede-lace-up-block-heels", "cider-brown-knee-high-boots", "brown-patent-ankle-strap-pumps", "brown-patent-two-strap-pumps", "navy-suede-ankle-strap-pumps", "black-white-tstrap-pointed-pumps", "black-patent-gold-buckle-mary-jane-heels"], from: [560, 1030], to: [1380, 1030], w: [84, 84], z: 60 },
  ...
  { id: "outer-right-second", name: "Outer right bay · second bar", ids: ["temu-floral-lingerie-set", "shein-sailor-collar", "chiffon-neck-scarf-black", "chiffon-neck-scarf-yellow", "chiffon-neck-scarf-navy", "chiffon-neck-scarf-green", "chiffon-neck-scarf-ivory", "chiffon-neck-scarf-burgundy", "chiffon-neck-scarf-purple", "chiffon-neck-scarf-brown", "pink-marabou-lingerie-set", "forever21-coca-cola-red-swimsuit", "eollystrel-burgundy-lace-corset-top"], from: [1830, 158], to: [1664, 250], w: [90, 82], hang: true, z: 30 },
  { id: "outer-right-bottom", name: "Outer right bay · bottom bar", ids: ["burberry-canvas-tote", "prada-blue-bag", "prada-tan-shoulder-bag", "gucci-gg-shoulder-bag"], from: [1852, 772], to: [1662, 738], w: [92, 84], hang: true, z: 32 },
];
...
const TALL: Line[] = [
  ...
  { id: "shoes", name: "Shoes on the floor", ids: ["shein-mint-maryjanes", "amz-coutgo-heels", "amz-lolita-maryjanes", "amz-maryjanes-kalstage", "amz-tstrap-maryjanes", "shein-bow-loafers", "amz-birkenstock-gizeh", "temu-hamster-slippers", "amz-roller-skates", "dh-rain-boots", "tt-black-slingbacks", "tt-red-slingbacks", "shein-fur-snow-boots", "bw-bow-slingback-heels", "bw-bow-slingback-heels-front", "sage-burgundy-bow-slingback-heels", "yellow-bow-kitten-heels", "black-patent-chain-platform-loafers", "black-patent-triple-strap-platform-mary-janes", "louis-vuitton-damier-peep-toe-heels", "louis-vuitton-damier-peep-toe-heels-front", "green-suede-lace-up-block-heels", "cider-brown-knee-high-boots", "brown-patent-ankle-strap-pumps", "brown-patent-two-strap-pumps", "navy-suede-ankle-strap-pumps", "black-white-tstrap-pointed-pumps", "black-patent-gold-buckle-mary-jane-heels"], from: [120, 1650], to: [820, 1650], w: [72, 72], z: 60 },
