...
const TALL: Line[] = [
  ...
  { id: "window-hooks-side", name: "Window moulding · hooks down the right", ids: ["etsy-purple-veil", "etsy-green-lace-veil", "etsy-floral-embroidered-veil", "etsy-gold-floral-veil", "etsy-black-gold-veil-long", "temu-mantilla", "etsy-bernadette-veil", "light-blue-floral-lace-trim-head-scarf", "pink-floral-lace-trim-head-scarf"], from: [610, 524], to: [610, 838], w: [46, 46], hang: true, z: 36, hooks: 5 },
