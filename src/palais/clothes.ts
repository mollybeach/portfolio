...
const WIDE: Line[] = [
  ...
  { id: "rack-right", name: "Right rolling rack", ids: ["dh-tweed-set-ivory", "dh-tweed-set-black", "dh-puffer-jacket", "white-fur-hood-parka", "dh-goose-jacket-pink", "amz-floral-sweatshirt", "shein-halfzip", "temu-tie-cardigan", "temu-heart-bikini", "dh-fur-coat", "dh-cc-bikini", "tt-striped-vest-set", "tt-striped-collar-set", "rhone-utility-trench-navy", "zeagoo-fur-lapel-wool-coat-navy", "maroon-wool-trench-coat", "green-wool-cropped-jacket-ruffle-skirt-set", "navy_satin_lace_slip_dress_sticker", "cream_rose_floral_lace_dress_sticker", "ivory_satin_lace_slip_dress_sticker", "forest_green_lace_satin_dress_sticker"], from: [1066, 612], to: [1314, 612], w: [112, 104], hang: true, z: 46 },
...
const TALL: Line[] = [
  ...
  { id: "rack-front", name: "Front rolling rack", ids: ["amz-floral-sweatshirt", "shein-halfzip", "temu-tie-cardigan", "temu-heart-bikini", "temu-beach-swimsuit", "dh-goose-jacket-pink", "dh-puffer-jacket", "white-fur-hood-parka", "dh-fur-coat", "dh-cc-bikini", "tt-striped-vest-set", "tt-striped-collar-set", "cream-fluffy-coat", "brown-quilted-knit-jacket", "rhone-utility-trench-navy", "zeagoo-fur-lapel-wool-coat-navy", "maroon-wool-trench-coat", "green-wool-cropped-jacket-ruffle-skirt-set", "cloud_cardigan_blue_white_knit_sticker", "grape-cluster-organza-mermaid-gown", "macaw-print-gold-silk-ball-gown", "midnight-star-flamingo-embroidered-gown", "midsommar-wildflower-gown"], from: [150, 1255], to: [790, 1255], w: [96, 96], hang: true, z: 40 },
