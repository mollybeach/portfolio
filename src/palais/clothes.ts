...
const WIDE: Line[] = [
  ...
  { id: "shoes", name: "Shoes on the floor", ids: ["shein-mint-maryjanes", "amz-coutgo-heels", "amz-lolita-maryjanes", "amz-maryjanes-kalstage", "amz-tstrap-maryjanes", "shein-bow-loafers", "amz-birkenstock-gizeh", "temu-hamster-slippers", "amz-roller-skates", "dh-rain-boots", "tt-black-slingbacks", "tt-red-slingbacks", "shein-fur-snow-boots", "bw-bow-slingback-heels-front", "sage-burgundy-bow-slingback-heels-front", "yellow-bow-kitten-heels", "black-patent-chain-platform-loafers", "black-patent-triple-strap-platform-mary-janes", "louis-vuitton-damier-peep-toe-heels-front", "green-suede-lace-up-block-heels", "cider-brown-knee-high-boots", "brown-patent-ankle-strap-pumps", "brown-patent-two-strap-pumps", "navy-suede-ankle-strap-pumps", "burgundy-ribbon-tie-block-heels", "black-white-tstrap-pointed-pumps", "black-patent-gold-buckle-mary-jane-heels"], from: [560, 1030], to: [1380, 1030], w: [84, 84], z: 60 },
