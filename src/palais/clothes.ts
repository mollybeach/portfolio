...
const WIDE: Line[] = [
  ...
  { id: "seat", name: "Window seat", ids: ["temu-saddle-bag", "shein-fluffy-shawl", "temu-bow-handbag", "pink-sherpa-pom-pom-bucket-bag", "white-prada-re-edition-shoulder-bag"], from: [918, 690], to: [1020, 690], w: [74, 74], z: 20 },
