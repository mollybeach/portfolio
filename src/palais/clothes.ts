...
const TALL: Line[] = [
  ...
  // the window seat
  { id: "seat", name: "Window seat", ids: ["temu-saddle-bag", "temu-fur-buckethat", "temu-rose-beanie", "shein-fluffy-shawl", "temu-fur-headband", "temu-bow-handbag", "dh-check-tote", "dh-hobo-bag", "dh-brown-tote", "burberry-canvas-tote", "prada-blue-bag", "gucci-gg-shoulder-bag", "pink-sherpa-pom-pom-bucket-bag", "black-faux-fur-cuff-bracelets-pair", "white-faux-fur-cuff-bracelets-pair", "white-prada-re-edition-shoulder-bag", "louis-vuitton-denim-monogram-pochette", "louis-vuitton-damier-azur-felicie-pochette", "red-faux-fur-round-hat", "pink-faux-fur-round-hat", "green-faux-fur-round-hat"], from: [296, 968], to: [626, 968], w: [58, 58], z: 20 },
  { id: "window-hooks-top", name: "Window moulding · hooks across the top", ids: ["shein-bear-ear-bonnet", "shein-black-fur-beanie", "shein-lamb-bonnet", "shein-white-fur-hat", "shein-mint-fur-bucket-hat", "icelandic-white-fur-hat", "brown-faux-fur-round-hat", "beige-rib-knit-pom-pom-ears-beanie"], from: [332, 452], to: [590, 452], w: [46, 46], hang: true, z: 36, hooks: 8 },
