...
const WIDE: Line[] = [
  ...
  { id: "seat", name: "Window seat", ids: ["temu-saddle-bag", "shein-fluffy-shawl", "temu-bow-handbag", "shein-lamb-bonnet", "shein-white-fur-hat", "shein-mint-fur-bucket-hat", "icelandic-white-fur-hat", "pink-sherpa-pom-pom-bucket-bag"], from: [918, 690], to: [1020, 690], w: [74, 74], z: 20 },
