...
const WIDE: Line[] = [
  ...
  { id: "right-top", name: "Right bay · top rail", ids: ["temu-offshoulder-dress", "shein-cable-set", "shein-check-cami", "shein-dazy-set", "shein-ribbed-top", "cloud_cardigan_blue_white_knit_sticker"], from: [1598, 200], to: [1472, 280], w: [104, 92], hang: true, z: 70 },
  ...
  { id: "seat", name: "Window seat", ids: ["temu-saddle-bag", "shein-fluffy-shawl", "temu-bow-handbag", "pink-sherpa-pom-pom-bucket-bag", "white-prada-re-edition-shoulder-bag", "louis-vuitton-denim-monogram-pochette", "louis-vuitton-damier-azur-felicie-pochette"], from: [918, 690], to: [1020, 690], w: [74, 74], z: 20 },
  // the two rolling rails
  { id: "rack-left", name: "Left rolling rack", ids: ["ref-shai-dress", "amz-tulle-dress-blue", "dh-knit-skirt-set", "amz-tulle-dress-green", "cider-ruffle-velvet-dress", "amz-fairies-dress", "temu-ditsy-splitdress", "temu-satin-robe", "cider-velvet-corset-dress", "shein-green-organza-dress", "wona-istanbul-chiffon-ruffle-dress-black", "blue-corset-mini-dress", "black-beige-pleated-belted-dress", "denim-corset-flared-dress", "hm-black-white-piped-keyhole-mini-dress", "mint_green_ruffled_corset_gown_sticker", "powder_blue_scarf_maxi_dress_sticker"], from: [622, 612], to: [868, 612], w: [118, 118], hang: true, z: 46 },
...
const TALL: Line[] = [
  ...
  // the window seat
  { id: "seat", name: "Window seat", ids: ["temu-saddle-bag", "temu-fur-buckethat", "temu-rose-beanie", "shein-fluffy-shawl", "temu-fur-headband", "temu-bow-handbag", "dh-check-tote", "dh-hobo-bag", "dh-brown-tote", "shein-bear-ear-bonnet", "shein-black-fur-beanie", "shein-lamb-bonnet", "shein-white-fur-hat", "shein-mint-fur-bucket-hat", "burberry-canvas-tote", "prada-blue-bag", "gucci-gg-shoulder-bag", "icelandic-white-fur-hat", "pink-sherpa-pom-pom-bucket-bag", "black-faux-fur-cuff-bracelets-pair", "white-faux-fur-cuff-bracelets-pair", "white-prada-re-edition-shoulder-bag", "louis-vuitton-denim-monogram-pochette", "louis-vuitton-damier-azur-felicie-pochette", "brown-faux-fur-round-hat", "beige-rib-knit-pom-pom-ears-beanie", "red-faux-fur-round-hat", "pink-faux-fur-round-hat"], from: [318, 948], to: [578, 948], w: [50, 50], z: 20 },
